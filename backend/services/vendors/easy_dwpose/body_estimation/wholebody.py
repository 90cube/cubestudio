...
class Wholebody:
    """Detect human pose by DWPose (YOLOX + RTMPose ONNX).

    Thin vendor wrapper adapted from canonical easy_dwpose implementation.
    """
    ...
    def __call__(self, oriImg):
        """
        Run whole body detection on an RGB image array (H, W, 3).
        Returns keypoints (N, K=18, 2) normalized to image size and scores (N, K).
        """
